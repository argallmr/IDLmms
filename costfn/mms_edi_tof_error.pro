...
;-
function mms_edi_tof_error, tofarr1, tofarr2
	compile_opt idl2
	on_error, 2
...
;---------------------------------------------------------------------
	...
	n1factor = sqrt( 1.0/(n1-1) * sqsum1 ) / sqrt(n1) ; stdev(tofarr1) / sqrt(n1)
	n2factor = sqrt( 1.0/(n2-1) * sqsum2 ) / sqrt(n2) ; stdev(tofarr2) / sqrt(n2)
