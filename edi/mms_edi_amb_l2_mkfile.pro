...
;-
function mms_edi_amb_l2_mkfile, sc, mode, tstart, amb_data, $
BRST=brst, $
...
;------------------------------------------------------
	...
	if mode eq 'brst' then begin
		...
		;Errors
		oamb -> CreateVar, flux1_0_delta_vname,   'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux2_0_delta_vname,   'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux3_0_delta_vname,   'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux4_0_delta_vname,   'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux1_180_delta_vname, 'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux2_180_delta_vname, 'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux3_180_delta_vname, 'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux4_180_delta_vname, 'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
	endif else begin
		;Flux
		oamb -> CreateVar, flux1_0_vname,   'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
		oamb -> CreateVar, flux1_180_vname, 'CDF_FLOAT', COMPRESSION='GZIP', GZIP_LEVEL=6
...
;------------------------------------------------------
	...
	oamb -> WriteVarAttr, traj1_gsm_0_vname, 'DEPEND_0',        t_vname
	...
	oamb -> WriteVarAttr, traj1_gsm_180_vname, 'DEPEND_0',        t_vname
	...
	oamb -> WriteVarAttr, flux1_0_delta_vname, 'DEPEND_0',      t_vname
	...
	oamb -> WriteVarAttr, flux1_180_delta_vname, 'DEPEND_0',      t_vname
	...
	if mode eq 'brst' then begin
		...
		oamb -> WriteVarAttr, flux2_0_delta_vname, 'DEPEND_0',      t_vname
		...
		oamb -> WriteVarAttr, flux2_180_delta_vname, 'DEPEND_0',      t_vname
		...
		oamb -> WriteVarAttr, flux3_0_delta_vname, 'DEPEND_0',      t_vname
		...
		oamb -> WriteVarAttr, flux3_180_delta_vname, 'DEPEND_0',      t_vname
		...
		oamb -> WriteVarAttr, flux4_0_delta_vname, 'DEPEND_0',      t_vname
		...
		oamb -> WriteVarAttr, flux4_180_delta_vname, 'DEPEND_0',      t_vname
		...
		oamb -> WriteVarAttr, traj2_gsm_0_vname, 'DEPEND_0',        t_vname
		...
		oamb -> WriteVarAttr, traj3_gsm_0_vname, 'DEPEND_0',        t_vname
		...
		oamb -> WriteVarAttr, traj4_gsm_0_vname, 'DEPEND_0',        t_vname
		...
		oamb -> WriteVarAttr, traj2_gsm_180_vname, 'DEPEND_0',        t_vname
		...
		oamb -> WriteVarAttr, traj3_gsm_180_vname, 'DEPEND_0',        t_vname
		...
		oamb -> WriteVarAttr, traj4_gsm_180_vname, 'DEPEND_0',        t_vname
