...
;
; NAME:
;    mms_edi_amb_ql_mkfile_perp
;
; PURPOSE:
;+
;   Make an empty CDF file for perpendicular pitch angle mode EDI ambient data.
;
; :Categories:
;    MMS, EDI, QL, Ambient
;
...
;       OPTDESC:            in, required, type=string, default='amb-perp'
...
;-
function mms_edi_amb_ql_mkfile_perp, sc, mode, optdesc, tstart, $
...
;------------------------------------------------------
	...
	;EPOCH
	oamb -> WriteVarAttr, t_vname, 'CATDESC',       'TT2000 time tags for perpendicular pitch angle electron counts.'
...
;------------------------------------------------------
	...
	oamb -> WriteVarAttr, counts1_90_gdu1_vname, 'DEPEND_0',      t_vname
	oamb -> WriteVarAttr, counts1_90_gdu1_vname, 'DISPLAY_TYPE', 'time_series'
	oamb -> WriteVarAttr, counts1_90_gdu1_vname, 'FIELDNAM',     'Perpendicular electron counts GDU1'
	...
	oamb -> WriteVarAttr, counts1_90_gdu2_vname, 'CATDESC',      'Perpendicular electrons from' + ch[0] + ' GDU2. Actual ' + $
	                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
	                                                             'products guide for more details.'
	oamb -> WriteVarAttr, counts1_90_gdu2_vname, 'DEPEND_0',      t_vname
	oamb -> WriteVarAttr, counts1_90_gdu2_vname, 'DISPLAY_TYPE', 'time_series'
	oamb -> WriteVarAttr, counts1_90_gdu2_vname, 'FIELDNAM',     'Perpendicular electron counts GDU2'
	...
	if mode eq 'brst' then begin
		...
		oamb -> WriteVarAttr, counts2_90_gdu1_vname, 'CATDESC',      'Perpendicular electrons from' + ch[1] + ' GDU1. Actual ' + $
		                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
		                                                             'products guide for more details.'
		oamb -> WriteVarAttr, counts2_90_gdu1_vname, 'DEPEND_0',      t_vname
		oamb -> WriteVarAttr, counts2_90_gdu1_vname, 'DISPLAY_TYPE', 'time_series'
		oamb -> WriteVarAttr, counts2_90_gdu1_vname, 'FIELDNAM',     'Perpendicular electron counts GDU1'
		...
		oamb -> WriteVarAttr, counts3_90_gdu1_vname, 'CATDESC',      'Perpendicular electrons from' + ch[2] + ' GDU1. Actual ' + $
		                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
		                                                             'products guide for more details.'
		oamb -> WriteVarAttr, counts3_90_gdu1_vname, 'DEPEND_0',      t_vname
		oamb -> WriteVarAttr, counts3_90_gdu1_vname, 'DISPLAY_TYPE', 'time_series'
		oamb -> WriteVarAttr, counts3_90_gdu1_vname, 'FIELDNAM',     'Perpendicular electron counts GDU1'
		...
		oamb -> WriteVarAttr, counts4_90_gdu1_vname, 'CATDESC',      'Perpendicular electrons from channel' + ch[3] + ' GDU1. Actual ' + $
		                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
		                                                             'products guide for more details.'
		oamb -> WriteVarAttr, counts4_90_gdu1_vname, 'DEPEND_0',      t_vname
		oamb -> WriteVarAttr, counts4_90_gdu1_vname, 'DISPLAY_TYPE', 'time_series'
		oamb -> WriteVarAttr, counts4_90_gdu1_vname, 'FIELDNAM',     'Perpendicular electron counts GDU1'
		...
		oamb -> WriteVarAttr, counts2_90_gdu2_vname, 'CATDESC',      'Perpendicular electrons from' + ch[1] + ' GDU2. Actual ' + $
		                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
		                                                             'products guide for more details.'
		oamb -> WriteVarAttr, counts2_90_gdu2_vname, 'DEPEND_0',      t_vname
		oamb -> WriteVarAttr, counts2_90_gdu2_vname, 'DISPLAY_TYPE', 'time_series'
		oamb -> WriteVarAttr, counts2_90_gdu2_vname, 'FIELDNAM',     'Perpendicular electron counts GDU2'
		...
		oamb -> WriteVarAttr, counts3_90_gdu2_vname, 'CATDESC',      'Perpendicular electrons from' + ch[2] + ' GDU2. Actual ' + $
		                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
		                                                             'products guide for more details.'
		oamb -> WriteVarAttr, counts3_90_gdu2_vname, 'DEPEND_0',      t_vname
		oamb -> WriteVarAttr, counts3_90_gdu2_vname, 'DISPLAY_TYPE', 'time_series'
		oamb -> WriteVarAttr, counts3_90_gdu2_vname, 'FIELDNAM',     'Perpendicular electron counts GDU2'
		...
		oamb -> WriteVarAttr, counts4_90_gdu2_vname, 'CATDESC',      'Perpendicular electrons from' + ch[3] + ' GDU2. Actual ' + $
		                                                             'pitch-angle depends on packing mode. See the EDI data ' + $
		                                                             'products guide for more details.'
		oamb -> WriteVarAttr, counts4_90_gdu2_vname, 'DEPEND_0',      t_vname
		oamb -> WriteVarAttr, counts4_90_gdu2_vname, 'DISPLAY_TYPE', 'time_series'
		oamb -> WriteVarAttr, counts4_90_gdu2_vname, 'FIELDNAM',     'Perpendicular electron counts GDU2'
