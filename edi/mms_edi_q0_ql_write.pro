...
;-
function mms_edi_q0_ql_write, sc, mode, tstart, q0_data, $
...
;------------------------------------;
	...
	; Check sizes
	;
	if ~isa(q0_data.tt2000_gd12,    'LONG64') then message, 'q0_data.tt2000_gd12 must be LONG64.'
	if ~isa(q0_data.tt2000_gd21,    'LONG64') then message, 'q0_data.tt2000_gd21 must be LONG64.'
	...
	if ~isa(q0_data.energy_gd12,    'UINT')   then message, 'q0_data.energy_gd12 must be UINT.'
	if ~isa(q0_data.energy_gd21,    'UINT')   then message, 'q0_data.energy_gd21 must be UINT.'
	if ~isa(q0_data.q0_gd12,        'UINT')   then message, 'q0_data.q0_gd12 must be UINT.'
	if ~isa(q0_data.q0_gd21,        'UINT')   then message, 'q0_data.q0_gd21 must be UINT.'
...
;------------------------------------------------------
	...
	oq0 -> WriteVar, /CREATE, epoch_gdu1_vname,    q0_data.tt2000_gd21,    CDF_TYPE='CDF_TIME_TT2000'
	oq0 -> WriteVar, /CREATE, epoch_gdu2_vname,    q0_data.tt2000_gd12,    CDF_TYPE='CDF_TIME_TT2000'
	oq0 -> WriteVar, /CREATE, epoch_timetag_vname, q0_data.tt2000_timetag, CDF_TYPE='CDF_TIME_TT2000'
	oq0 -> WriteVar, /CREATE, e_gdu1_vname,        q0_data.optics,      COMPRESSION='GZIP', GZIP_LEVEL=6
	oq0 -> WriteVar, /CREATE, e_gdu1_vname,        q0_data.energy_gd21, COMPRESSION='GZIP', GZIP_LEVEL=6
	oq0 -> WriteVar, /CREATE, e_gdu2_vname,        q0_data.energy_gd12, COMPRESSION='GZIP', GZIP_LEVEL=6
	oq0 -> WriteVar, /CREATE, q0_gdu1_vname,       q0_data.q0_gd21,     COMPRESSION='GZIP', GZIP_LEVEL=6
	oq0 -> WriteVar, /CREATE, q0_gdu2_vname,       q0_data.q0_gd12,     COMPRESSION='GZIP', GZIP_LEVEL=6
